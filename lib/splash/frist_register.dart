...
class Frist_Register extends StatefulWidget {
   Frist_Register({super.key});

  @override
  State<Frist_Register> createState() => _Register_pageState();
}

class _Register_pageState extends State<Frist_Register> {
